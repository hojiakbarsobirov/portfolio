        ...
        <>
            <div className="bg-gray-900 w-full py-6 px-6 xl:px-2 flex flex-wrap justify-around gap-6">
                ...
                <div className=" w-full sm:w-[550px] h-[400px] flex flex-col justify-around items-start">
                    ...
                    <h3 className='text-4xl text-white'>I'm Hojiakbar</h3>
                    ...
                    <div className='space-x-8'>
                        ...
                        <button className='border rounded border-red-500 px-5 py-3 text-white font-medium hover:bg-red-700 transition ease-in-out'><Link target='_blank' to={'https://docs.google.com/document/d/1u7rGiRmLRNe6b34kODK-dLLr0U-wGjPykQF3qKfD6zU/edit?usp=sharing'}>My Resume</Link></button>
                    </div>
                </div>
